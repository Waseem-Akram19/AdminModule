...
const AddSingleItem = () => {
    ...
    // const [selectedsubCategory, setSelectedsubCategory] = useState("Breads"); // initialize with a default value
    // const [selectedsupCategory, setSelectedsupCategory] = useState("Pizza"); // initialize with a default value
    const [state, setState] = useState(initialState);
    const [showPlaceholders, setShowPlaceholders] = useState(true);
    const { itemName, itemPrice, itemQuantity, calories, carbs, protein, fats, sodium, sugar, selectedsubCategory,selectedsupCategory } = state;
    ...
    const handleAddSingleItem = (e) => {
        e.preventDefault();
        try {
            const dbRef = firebase.database().ref(`/Singlefooditem/${selectedsupCategory}/${selectedsubCategory}`);
            dbRef.push(state, () => {
                ...
                <div className='mx-5 adjustform'>
                    <Container>
                        <Row className=" mt-2 mb-3">
                            <Col>
                                <h1 className="text-center">Add Single Item</h1>
                                <hr style={{ borderBottom: '1px solid black' }}></hr>
                            </Col>
                        </Row>
                        <Row className='formcontainer'>
                            <Col>
                                <Form className="food-form" onSubmit={handleAddSingleItem}>
                                    <Form.Group controlId="category">
                                        <Form.Label>Category</Form.Label>
                                        <Form.Control as="select" value={selectedsupCategory} name='selectedsupCategory' onChange={handleCategoryChange}>
                                    ...
                                    <Form.Group controlId="category">
                                        <Form.Label>Category</Form.Label>
                                        <Form.Control as="select" value={selectedsubCategory} name='selectedsubCategory' onChange={handleCategoryChange}>
