...
const Deals = () => {
    ...
    const { itemName, itemPrice, itemQuantity, calories, carbs, protein, fats, sodium, sugar, deals } = state;
    // const [deals, setdeals] = useState("Fastfood"); // initialize with a default value
                ...
                <div className='mx-5 adjustform'>
                    <Container>
                        <Row className=" mt-2 mb-3">
                            <Col>
                                <h1 className="text-center">Add Deal</h1>
                        ...
                        <Row className='formcontainer'>
                            <Col>
                                ...
                                <Form.Group controlId="deals">
                                        <Form.Label>Deal Items</Form.Label>
                                        <Form.Control
                                            type="text"
                                            placeholder={showPlaceholders ? "Enter deal name" : ""}
